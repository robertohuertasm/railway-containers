...
>
    ...
    <input class="my-4  border-slate-500 w-full border-2  p-2 bg-slate-100 placeholder:text-slate-500 text-black" type="text" placeholder="Name of the image (e.g. kennethreitz/httpbin"  bind:value={imageValue} />
